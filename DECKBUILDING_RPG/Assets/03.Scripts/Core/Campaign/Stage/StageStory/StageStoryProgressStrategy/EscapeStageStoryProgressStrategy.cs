...
public class EscapeStageStoryProgresStrategy : AStageStoryProgressStrategy
{
    public EscapeStageStoryProgresStrategy(GameContext gameContext) : base(gameContext)
    {
    }
