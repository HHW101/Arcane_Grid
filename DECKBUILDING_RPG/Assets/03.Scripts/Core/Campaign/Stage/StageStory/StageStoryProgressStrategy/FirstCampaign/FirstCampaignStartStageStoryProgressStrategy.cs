...
public class FirstCampaignStartStageStoryProgresStrategy : AStageStoryProgressStrategy
{
    public FirstCampaignStartStageStoryProgresStrategy(GameContext gameContext) : base(gameContext)
    {
    }
