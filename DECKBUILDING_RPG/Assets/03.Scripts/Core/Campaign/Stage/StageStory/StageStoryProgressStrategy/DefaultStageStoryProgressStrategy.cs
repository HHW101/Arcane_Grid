...
public class DefaultStageStoryProgresStrategy : AStageStoryProgressStrategy
{
    public DefaultStageStoryProgresStrategy(GameContext gameContext) : base(gameContext)
    {
    }
