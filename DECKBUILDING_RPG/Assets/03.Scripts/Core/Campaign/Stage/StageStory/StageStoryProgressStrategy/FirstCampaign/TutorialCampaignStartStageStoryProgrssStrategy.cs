...
public class TutorialCampaignStartStageStoryProgrssStrategy : AStageStoryProgressStrategy
{
    public TutorialCampaignStartStageStoryProgrssStrategy(GameContext gameContext) : base(gameContext)
    {
    }
